...
import { ToggleWeekly } from "../../context/weather";
...
export default function TodayReport({ weatherCity }) {
  ...
  return (
    !toggleWeekly && (
      <section>
        <h2 className="font-bold text-2xl mt-8 mb-4 border-b-2 border-blue-400 inline-block">
          Today's Hightlights
        </h2>
        ...
        <div className="grid grid-cols-12 gap-4">
          <div className="col-span-12 xl:col-span-3 sm:col-span-6 bg-white p-3 ">
            <h5 className="text-gray-400 font-normal mt-3">
              Sunrise and Sunset
            </h5>
